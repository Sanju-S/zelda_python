...
class Player(Entity):
    def __init__(self, pos: tuple[int], groups: list[pygame.sprite.Group], obstacle_sprites: pygame.sprite.Group, create_attack, destroy_attack, create_magic) -> None:
    ...
    def input(self) -> None:
        if not self.attacking:
            ...
            # magic input
            if keys[pygame.K_LCTRL] or keys[pygame.K_v]:
                self.attacking = True
                self.attack_time = pygame.time.get_ticks()
    ...
    def get_full_weapon_damage(self) -> int:
        ...
        weapon_damage: int = weapon_data[self.weapon]['damage']

        return base_damage + weapon_damage

    def get_full_magic_damage(self) -> int:
        base_damage = self.stats['magic']
        magic_damage: int = magic_data[self.magic]['strength']
